...
public class AlteraGecoiArquivos {
	...
	public String alterar(String vidConteudo, String vidArquivo, String vdescricao, String vidArea, String vdataAbertura, String vvigenciaInicial, String vvigenciaFinal, String vusuario, String vsenha, String vobservacao)
	{
		...
		try {
			...
			try
			{
				...
				String vsql = "{call gecoi.g_processar_alteracao_arquivo(?, ?, ?, ?, ?, ?, ?, ?, null, ?, ?, null, null)";
				...
				cs.setInt(7, Integer.parseInt(vidArea));
				cs.setString(8, vdataAbertura);
				cs.setInt(9, Integer.parseInt(vidArquivo));
				cs.setString(10, vdescricao);
				cs.execute();
