...
public class GravaNovoArquivo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (isMultipart) {
			...
			complemento = ((FileItem)multiparts.get(2)).getString();
			nomeArquivo = ((FileItem)multiparts.get(3)).getName();
			//System.out.println("Esse é o complemento: " +complemento);			
			...
			try {
				...
				multiparts.get(3).write(new File(diretorio + arquivoObjeto));
			...
			pw.print("<script>top.carregaAPP('/gecoi.3.0/apps/revista_jurisprudencia/index.jsp','');</script>");
		}		
	}
}
