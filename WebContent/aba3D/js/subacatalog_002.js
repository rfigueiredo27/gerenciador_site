...
// IE6 in standards compliant mode (i.e. with a valid doctype as the first line in the document)
 ...
 else
 {
	...
	document.write("<div style='display:none'>.</div><div id='intermission' style='position:absolute;"+xwidth+"height:"+ varAltura +";z-index:1000;top:"+ varTopo +"px;'><object classid=clsid:D27CDB6E-AE6D-11cf-96B8-444553540000 codebase=http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0 width="+ varLargura +" height="+ varAltura +"><param name=movie value="../../teste/js/+ urlArquivo +"?id="+ varId +"&tagname="+ varTagname +"><param name=quality value=high><param name=wmode value=transparent><param name=allowScriptAccess value=always><embed src="../../teste/js/+ urlArquivo +"?id="+ varId +"&tagname="+ varTagname +" width="+ varLargura +" height="+ varAltura +" quality=high pluginspage=http://www.macromedia.com/go/getflashplayer type=application/x-shockwave-flash wmode=transparent allowScriptAccess=always></embed></object></div>");
