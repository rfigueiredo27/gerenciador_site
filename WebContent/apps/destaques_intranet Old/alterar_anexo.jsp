...
<c:set var="items" value="${lista.getListaAnexos(idConteudo)}" />
<c:choose>
      			...
      			<tr>
        			...
        			<td>
        				...
        				<c:if test="${conta.index + 1 < anexo.total }">
           				...
           				<a href="/gecoi.3.0/apps/destaques_intranet/alterar_descricao_anexo.jsp?id=${anexo.idArquivo }&descricao=${anexo.descricao }&idConteudo=<%=vidConteudo%>"><img width="20" height="20" src="/gecoi.3.0/img/texto.jpg" /></a>
