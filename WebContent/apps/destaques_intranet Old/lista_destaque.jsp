	...
	<form name="flista">
		...
		<c:forEach var="destaque" items="${items}" >
			<tr>
				...
				<c:if test="${destaque.temAnexo > 0 }">
				   <td><a href="/gecoi.3.0/apps/destaques_intranet/alterar_anexo.jsp?idConteudo=${destaque.idConteudo }&keepThis=true&TB_iframe=true&height=350&width=600" class="thickbox" target="divthick" title="Manutenção do anexo"><img id="foto${destaque.idConteudo }" name="anexo${destaque.idConteudo }" src="/gecoi.3.0/img/maquina_digital.jpg" onclick="" width="30" height="30" /></a></td>
				</c:if>
				<td>${destaque.dataIni }</td>
				<td>${destaque.dataFim }</td>
				<td><a href="/gecoi.3.0/apps/destaques_intranet/alterar_dados.jsp?id=${destaque.idArquivo }&idConteudo=${destaque.idConteudo }&descricao=${destaque.descricao }&publicado=${destaque.publicado }&link=${destaque.observacao }&dataIni=${destaque.dataIni }&dataFim=${destaque.dataFim }&keepThis=true&TB_iframe=false&height=300&width=500" class="thickbox" title="Manutenção do destaque"><img id="foto${destaque.idConteudo }" name="foto${destaque.idConteudo }" src="/gecoi.3.0/img/maquina_digital.jpg" onclick="" width="30" height="30" /></a></td>
				<td><a href="/gecoi.3.0/apps/destaques_intranet/alterar_banner.jsp?id=${destaque.idArquivo }&idConteudo=${destaque.idConteudo }&descricao=${destaque.descricao }&nome=${destaque.nomeArquivo }&keepThis=true&TB_iframe=true&height=550&width=800" class="thickbox" target="divthick" title="Manutenção do banner"><img id="foto${destaque.idConteudo }" name="foto${destaque.idConteudo }" src="/gecoi.3.0/img/maquina_digital.jpg" onclick="" width="30" height="30" /></a></td>
				<td><a href="#" title="Exclusão do banner"><img id="excluir${destaque.idArquivo }" name="excluir${destaque.idArquivo }" src="/gecoi.3.0/img/botao_excluir.png" width="30" height="30" onclick="excluir('${destaque.idConteudo }', '${destaque.descricao }', ${destaque.publicado });" /></a></td>
