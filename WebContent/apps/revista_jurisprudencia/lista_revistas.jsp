...
<jsp:useBean id="lista"
	class="br.jus.trerj.controle.revistaJurisprudencia.ListaRevistaJurisprudencia" />
<c:set var="items"
	value="${lista.getListaRevistaJurisprudencia(sessionScope['login'], sessionScope['senha'])}" />
<c:choose>
	<c:when test="${!empty items}">
		<form name="flista">
			<h3 align="center">Lista de Revistas Jurisprudência</h3>
			<br><br>
					...
					<tbody>
						<c:forEach var="revistas" items="${items}">
							...
							<tr>
								...
								<td align="center" width="10%">${revistas.complemento }</td>
								<td align="center" width="20%"><div class='divAcoes'>
									...
									<a href="#"	onclick="carregaPag('/gecoi.3.0/apps/revista_jurisprudencia/alterar_dados.jsp?idConteudo=${revistas.idConteudo }&idArquivo=${revistas.idArquivo }&descricao=${revistas.descricao_arquivo }&data=${revistas.dataPublicacao }&volume=${revistas.volume }&numero=${revistas.numero }&complemento=${revistas.complemento }&area=${revistas.idArea }','divbusca');"
									...
									<a href="#" onclick="carregaPag('/gecoi.3.0/apps/revista_jurisprudencia/alterar_arquivo.jsp?id=${revistas.idConteudo }&idArquivo=${revistas.idArquivo }&descricao=${revistas.descricao_arquivo }','divbusca');"
