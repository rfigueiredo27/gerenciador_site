...
<%
   ...
   int vgrupo = (request.getParameter("unidade") == null ? 0 : Integer.parseInt(request.getParameter("unidade")));
   int conta_var = 0;
   int conta;
   String vsql;
                            ...
                            try
							{
							  ...
							  out.println("<select class='form-control' name='area2' id='area2' onchange='atualiza_ano_inclusao(this.form);'>");
