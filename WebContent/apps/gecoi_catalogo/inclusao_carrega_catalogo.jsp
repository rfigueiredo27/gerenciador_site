...
<%
   ...
   out.print("<h5>Inclusão no Catálogo: "+vcatalogo+"</h5>");
		...
		do {
			...
			if (vtipo == 3)
				out.println("<td align='center'><a href='/gecoi.3.0/apps/gecoi_catalogo/download_arquivo_reduzido.jsp?idarquivo=" + resultSet.getString("id_arquivo")
						+ "&keepThis=true&TB_iframe=false&height=300&width=400;' class='thickbox' title='Visualização do Arquivo' alt='Visualização do Arquivo' target='_blank'><img src='/gecoi.3.0/img/consulta.png' alt='Visualizar' border='0'></a>&nbsp;</td>");
