...
{
	parent.tb_remove();
	carregaPag("/gecoi.3.0/apps/gecoi_avisos/alterar_anexo.jsp?id=" + document.fanexo.idConteudo.value , "divbusca");
}
...
function excluirAnexo(vidArquivo, vidConteudo)
{
	if (confirm("Deseja realmente excluir o anexo ?") == true)
		$.post("/gecoi.3.0/apps/global/processa_exclusao_anexo.jsp", {idArquivo : vidArquivo}, 
				function(){carregaPag("/gecoi.3.0/apps/gecoi_avisos/alterar_anexo.jsp?id=" + vidConteudo ,"divbusca");});
	...
	<fieldset>
		...
		<div id="anexo_tabela">
			<form name="fanexo">
					...
					<tbody>
						<c:forEach var="anexo" items="${items}">
							...
							<tr bgcolor=<%=vcor%>>
								...
								<td width="2%"><a href="#"
									onclick="carregaPag('/gecoi.3.0/apps/gecoi_avisos/altera_arquivo_anexo.jsp?idConteudo=${anexo.idConteudo }&idArquivo=${anexo.idArquivo }&descricao=${anexo.descricao }','divbusca');"
									title="Substitui&ccedil;&atilde;o do Arquivo Anexo"><img
										...
										height="22" /></a></td>
								<td width="2%"><a href="#"
									onclick="carregaPag('/gecoi.3.0/apps/gecoi_avisos/alterar_descricao_anexo.jsp?idConteudo=${anexo.idConteudo }&idArquivo=${anexo.idArquivo }&descricao=${anexo.descricao }','divbusca');"
				...
				<div id="anexo">
					<a href="#"
						onclick="carregaPag('/gecoi.3.0/apps/gecoi_avisos/incluir_anexo.jsp?idConteudo=${idConteudo}','divbusca');">(+)
						Incluir Anexo</a>
				</div>
			</form>
		</div>
