...
{
	//parent.tb_remove();
	parent.carregaPag("/gecoi.3.0/apps/gecoi_avisos/alterar_anexo.jsp?id=" + document.fincAnexo.idconteudo.value , "divbusca");
}
...
{	
	...
	//startProgress();
	//parent.tb_remove();
	//carregaPag("/gecoi.3.0/apps/gecoi_avisos/alterar_anexo.jsp?id=" + document.fincAnexo.idconteudo.value + "&nProcesso=" + document.fincAnexo.nProcesso.value + "&nPregao=" + document.fincAnexo.nPregao.value,"divbusca");
}
...
<input type="hidden" name="app" id="app" value="/gecoi.3.0/apps/gecoi_avisos/alterar_anexo.jsp?id=<%=vidConteudo %>"/>
