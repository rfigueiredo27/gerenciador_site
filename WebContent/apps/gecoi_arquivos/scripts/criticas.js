...
function critica_altera_arquivos(f)
{
	...
	if (f.descricao_conteudo.value.replace(/^\s*|\s*$/g,"")=="")
	{
		msg = msg + "- O campo DESCRICAO DO CONTEUDO n\u00e3o foi preenchido.\n";
	}
	
	if (f.descricao_arquivo.value.replace(/^\s*|\s*$/g,"")=="")
	{
		msg = msg + "- O campo DESCRICAO DO ARQUIVO n\u00e3o foi preenchido.\n";
	}
