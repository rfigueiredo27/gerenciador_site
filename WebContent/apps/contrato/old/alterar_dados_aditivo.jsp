...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
      	<td>Vigência
			<input title="Vig&ecirc;ncia inicial do contrato" alt="Vig&ecirc;ncia inicial do contrato" type="text" name="vigenciaIni3" id="vigenciaIni3" size="10" maxlength="10" value="<%=vdataVigenciaInicial3 %>" /> a <input title="Vig&ecirc;ncia final do contrato" alt="Vig&ecirc;ncia final do contrato" type="text" name="vigenciaFim3" id="vigenciaFim3" size="10" maxlength="10"  value="<%=vdataVigenciaFinal3 %>" />
        </td>
      </tr>
      <tr>
