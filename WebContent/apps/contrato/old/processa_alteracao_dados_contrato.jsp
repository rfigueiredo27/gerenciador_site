...
<%
	...
	vdescricao = vnumProcesso + "-" + vnumContrato + "/" + vanoContrato + "-" + vdescricao;
	AlteraContrato altera = new AlteraContrato();
	altera.alterar(vidConteudo, vidArquivo, vdescricao, vdataVigenciaInicial + " a " + vdataVigenciaFinal, vdataPublicacao, session.getAttribute("login").toString(), session.getAttribute("senha").toString());
%>
