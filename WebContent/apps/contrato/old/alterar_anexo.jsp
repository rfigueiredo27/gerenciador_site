...
{
	//parent.tb_remove();
	//carregaPag("/gecoi.3.0/apps/contrato/alterar_anexo.jsp?idLicitacao=" + document.fanexo.idLicitacao.value + "&nProcesso=" + document.fanexo.nProcesso.value + "&nPregao=" + document.fanexo.nPregao.value, "divbusca");
}
...
function excluirAnexo(vidConteudo, plicitacao, pnProcesso, pnPregao)
{
	if (confirm("Deseja realmente excluir o contrato/aditivo ?") == true)
		$.post("/gecoi.3.0/apps/contrato/processa_exclusao.jsp", {idConteudo : vidConteudo}, 
				function(){carregaPag("/gecoi.3.0/apps/contrato/alterar_anexo.jsp?idLicitacao=" + plicitacao + "&nPregao=" + pnPregao + "&nProcesso=" + pnProcesso,"divbusca");});
}
</script>
<%
			...
			<c:forEach var="anexo" items="${items}" >
      			<tr>
        			...
        			<td>
           				...
           				<a href="#" onclick="carregaPag('/gecoi.3.0/apps/contrato/alterar_arquivo.jsp?idLicitacao=${idLicitacao }&id=${anexo.idConteudo }&idArquivo=${anexo.idArquivo }&nProcesso=${numProcesso}&nPregao=${numPregao}&descricao=${anexo.descricaoContrato }&titulo=Contrato&origem=principal','divbusca');" title="Substitui&ccedil;&atilde;o do Contrato"><img id="arquivo${anexo.idConteudo }" name="arquivo${anexo.idConteudo }" src="/gecoi.3.0/img/substituir.gif" onclick="" width="30" height="30" /></a>
           				...
           				<a href="#" onclick="excluirAnexo(${anexo.idConteudo }, ${idLicitacao}, '${numPregao}', '${numProcesso}');" title="Exclusão do Contrato"><img width="20" height="20" src="/gecoi.3.0/img/botao_excluir.png" /></a>
        			</td>
      			</tr>
			</c:forEach>
     			<tr>
