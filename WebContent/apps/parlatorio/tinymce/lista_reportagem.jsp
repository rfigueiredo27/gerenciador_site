...
<form name="flista">
	<table id="tb_gecoi"><thead>
		<tr>
			...
			<th scope="col" width="15%" colspan="3">A&Ccedil;&Otilde;ES</th>
		</tr></thead>
<% 
...
try
{
	...
	if ( resultSet.next() )
	{
		do 
		{
			...
			out.print("	<td align='center'><a href='/gecoi.3.0/apps/global/grava_arquivo.jsp?idArquivo=" + resultSet.getString("id_arquivo") + "' target='_blank' title='Visualiza&ccedil;&atilde;o da reportagem'><img id='arquivo" + resultSet.getString("id_arquivo") + "' name='arquivo" + resultSet.getString("id_arquivo") + "' src='/gecoi.3.0/img/consulta.png' onClick='' width='22' height='22' /></a></td>");
			...
			out.print("<td align='center'><a href='#' title='Exclus&atilde;o do PDF'><img id='excluir" + resultSet.getString("id_arquivo") + "' name='excluir" + resultSet.getString("id_arquivo") + "'  src='/gecoi.3.0/img/excluir_cinza.png' width='22' height='22' onclick=\"excluir('" + resultSet.getString("id_conteudo") + "', '" + vdescricao[0] + " - " + vdescricao[1] + "', 'Reportagem');\" /></a></td>");
			out.print("</tr>");
