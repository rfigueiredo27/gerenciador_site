...
String vhoje = "";
if ((c.get(Calendar.DATE) + 1) > 9)
	vhoje = "" + c.get(Calendar.DATE);
else
	vhoje = "0" + c.get(Calendar.DATE);
if ((c.get(Calendar.MONTH) + 1) > 9)
	vhoje = vhoje + "/" + (c.get(Calendar.MONTH) + 1) + "/" + c.get(Calendar.YEAR);
else
	vhoje = vhoje + "/0" + (c.get(Calendar.MONTH) + 1) + "/" + c.get(Calendar.YEAR);
String vsecao = "";
String vselecao = "";
/*
...
<div id="conteudo" >
    <div id='tabs'>
        ...
        <div id="tabs-3">
            <div id='tabs3'>
                <ul>
                    ...
                    <li><a href='#tabs-32' onclick="carregaPag('/gecoi.3.0/apps/parlatorio/lista_reportagem.jsp?operacao=reportagem', 'listaReportagem');" title="Alterar">Alterar</a></li>
                </ul>
                <div id='tabs-31'>
        ...
        <div id="tabs-4">
            <div id='tabs4'>
                <ul>
                    <li><a href='#tabs-41' onclick="carregaPag('/gecoi.3.0/apps/parlatorio/lista_reportagem.jsp?operacao=fundo', 'novo_fundo');" title="Novos" id="">Novos</a></li>
        ...
        <div id="tabs-5">
        	Relatorio de Likes<br />
            Relatorio de Compartilhamentos<br />
