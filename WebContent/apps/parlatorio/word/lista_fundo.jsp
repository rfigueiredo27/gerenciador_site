...
try
{
	...
	if ( resultSet.next() )
	{
		do 
		{
			...
			out.print("	<td><a href='/gecoi.3.0/apps/global/grava_arquivo.jsp?idArquivo=" + resultSet.getString("id_arquivo") + "' target='_blank' title='Visualiza&ccedil;&atilde;o da reportagem Fundo do Ba&uacute;'><img id='arquivo" + resultSet.getString("id_arquivo") + "' name='arquivo" + resultSet.getString("id_arquivo") + "' src='/gecoi.3.0/img/consulta.png' onClick='' width='22' height='22' /></a></td>");
			out.print("<td><a href='#' onclick=\"carregaPag('/gecoi.3.0/apps/parlatorio/manutencao_fundo.jsp?idConteudo=" + resultSet.getString("id_conteudo") + "','listaFundo');\"  title='Manuten&ccedil;&atilde;o da Reportagem Fundo do Ba&uacute;'><img id='reportagem" + resultSet.getString("id_arquivo") + "' name='reportagem" + resultSet.getString("id_arquivo") + "' src='/gecoi.3.0/img/texto.jpg' onClick='' width='22' height='22' /></a></td>");
			out.print("</tr>");
