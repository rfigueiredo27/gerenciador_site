...
try
{
	...
	if (!varquivoCapa.equals(""))
	{
		...
		if (vid_conteudo.equals(""))
		{
			vretorno = incluir.incluir("Edição nÂº " + vedicao + " do Jornal Parlatório", vdiretorio, vnomeArquivo, vid_area, session.getAttribute("login").toString(), session.getAttribute("senha").toString(), vdata, "",2, vcaminho, vedicao);
			vid_arquivo = vretorno.substring(vretorno.lastIndexOf("#")+1);
			vid_conteudo = vretorno.substring(vretorno.indexOf("#")+1,vretorno.lastIndexOf("#"));
		}
		else
