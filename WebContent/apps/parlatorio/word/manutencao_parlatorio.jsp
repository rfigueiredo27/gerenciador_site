...
%>
    ...
    <form name="faltparlatorio" action="/gecoi.3.0/apps/parlatorio/processa_alterar_parlatorio.jsp" method="post" target="rodapeAltera" enctype="multipart/form-data">
        ...
        <div id="arquivo_word">
            ...
            <input name="word" type="file" id="word" onchange="" >
            <% 
			if (vidArquivoWord > 0) 
            	out.print("<a href='/gecoi.3.0/apps/global/grava_arquivo.jsp?idArquivo=" + vidArquivoWord + "' target='_blank' title='Visualiza&ccedil;&atilde;o do arquivo em Word'><img id='arquivoword' name='arquivoword' src='/gecoi.3.0/img/consulta.png' onClick='' width='22' height='22' /></a>");
			%>
            </fieldset>
        </div>
        <div id="imagem_capa">
   		...
   		<input type="hidden" id="idArquivoWord" name="idArquivoWord" value="<%=vidArquivoWord%>" />
