...
<script src="/gecoi.3.0/apps/documentos_eliminacao/scripts/referencia.js" charset="UTF-8"></script>
<script src="/gecoi.3.0/apps/documentos_eliminacao/scripts/jquery.maskedinput.js" charset="UTF-8"></script>

<!-- <script src="/gecoi.3.0/apps/documentos_eliminacao/scripts/icheck.js"></script> -->
...
<link rel="stylesheet" media="all" type="text/css"	href="/gecoi.3.0/apps/documentos_eliminacao/css/altera_dados.css" />
<link rel="stylesheet" media="all" type="text/css"	href="/gecoi.3.0/css/tabela_gecoi.css" />
<link href="/gecoi.3.0/apps/documentos_eliminacao/css/grey.css" rel="stylesheet">
<link rel="stylesheet" media="all" type="text/css"	href="/gecoi.3.0/apps/documentos_eliminacao/css/gecoi.css" />
...
<script>
	...
	function listar(f) {
		...
		if (msg.replace(/^\s*|\s*$/g, "") == "") {
			...
			$.post("/gecoi.3.0/apps/documentos_eliminacao/manutencao.jsp", {
			}, function(resposta) {
