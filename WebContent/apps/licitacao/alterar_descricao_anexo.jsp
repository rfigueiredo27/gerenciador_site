...
function criticaAnexo()
{
	...
	//else
		$.post("/gecoi.3.0/apps/licitacao/processa_alteracao_descricao_anexo.jsp", {idConteudo: document.fdescAnexo.idconteudo.value, idArquivo : document.fdescAnexo.idarquivo.value, descricao : document.fdescAnexo.descricao_altera_anexo.value},
				function(){
