    ...
    <div id="relatorio_ano_descricao">
    	<fieldset>
        	<legend>Ano/Descri&ccedil;&atilde;o</legend>
     	    ...
     	    <div id="divDescricao"><select name="descricao" id="descricao_download" onchange=""></select></div>
        </fieldset>
    </div>
    
</div>
<div id="botao">
<input type="button" name="relatorio"  id="relatorio" value=" Emitir Relat&oacute;rio " onclick="imprime()" />
