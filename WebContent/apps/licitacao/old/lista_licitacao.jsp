...
<c:choose>
	<c:when test="${!empty items}">
				...
				<table id="tb_gecoi"><thead>
					<tr>
						<th scope="col" width="6%">MODALIDADE</th>
						...
						<th scope="col" width="8%">SITUA&Ccedil;&Atilde;O</th>
...
%>
			<tr bgcolor=<%=vcor%> >
				<td align="center" width="6%">${licitacao.tipo }</td>
				<td align="center" width="8%">${licitacao.numPregao }</td>
				<td align="left" width="40%">${licitacao.descricao }</td>
				...
				<td width="2%"><a href="/gecoi.3.0/apps/global/visualizar_arquivo.jsp?idConteudo=${licitacao.idConteudo }&idArquivo=${licitacao.idArquivo }" target="_blank" title="Visualização do arquivo"><img id="arquivo${licitacao.idConteudo }" name="arquivo${licitacao.idConteudo }" src="/gecoi.3.0/img/consulta.png" onclick="" width="22" height="22" /></a></td>		
				...
				<td width="2%"><a href="#" onclick="carregaPag('/gecoi.3.0/apps/licitacao/alterar_anexo.jsp?id=${licitacao.idConteudo }&nProcesso=${licitacao.numProcesso}&nPregao=${licitacao.numPregao}','divbusca');"  title="Manutenção dos Anexos"><img id="aditivo${licitacao.idConteudo }" name="aditivo${licitacao.idConteudo }" src="/gecoi.3.0/img/clips.png" onclick="" width="16" height="16" /></a></td>
				<td width="2%"><a href="#" title="Exclusão da licitação"><img id="excluir${licitacao.idConteudo }" name="excluir${licitacao.idConteudo }" src="/gecoi.3.0/img/excluir_cinza.png" width="22" height="22" onclick="excluir('${licitacao.idConteudo }', '${licitacao.numPregao }');" /></a></td></tr>
			</tr>					
		</c:forEach>
		</tbody></table>
	</form>
