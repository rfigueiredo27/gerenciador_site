...
<%
	...
	altera.alterar(vidConteudo, vidArquivo, vdescricao, vdataAbertura, vdataFechamento, vdataPublicacao, vtipo, session.getAttribute("login").toString(), session.getAttribute("senha").toString());
%>
