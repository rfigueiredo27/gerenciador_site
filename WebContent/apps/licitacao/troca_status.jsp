         ...
         <div id="status_situacao">
  			<fieldset>
                <legend>Situa&ccedil;&atilde;o</legend>
       				...
       				<div class="situacao">
                    	<input type="radio" name="filtro" id="filtro" value="A"  onclick="carrega_edital(this.form)" />
       						Abertos 
       					<input type="radio" name="filtro" id="filtro" value="E"  onclick="carrega_edital(this.form)" /> 
       						Encerrados
       					<input type="radio" name="filtro" id="filtro" value="S"  onclick="carrega_edital(this.form)" />
       						Suspensos
       					<input type="radio" name="filtro" id="filtro" value="R"  onclick="carrega_edital(this.form)" />
       						Revogados/Anulados 
       					<input type="radio" name="filtro" id="filtro" value="T" checked="checked" onclick="carrega_edital(this.form)" />
       						Todos
                    </div> 
