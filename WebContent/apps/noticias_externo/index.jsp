...
function listar(f)
{
	...
	$.post("/gecoi.3.0/apps/noticias_interno/lista_reportagem.jsp", {ano: f.ano.value, ambiente : f.ambienteAlteraReportagem.value}, function(resposta) {$("#resultado").html(resposta);});
}
