...
%>
			<tr bgcolor=<%=vcor%> >
				...
				<td><a href="#" onClick="carregaPag('/gecoi.3.0/apps/estudos_preliminares/lista_estudo.jsp?idLicitacao=${registro.idArquivo }&nPregao=${registro.numPregao }&nProcesso=${registro.numProcesso }&edital=${registro.descricao}','divbusca');"  title="Manutenção das Atas"><img id="aditivo${registro.idConteudo }" name="aditivo${registro.idConteudo }" src="/gecoi.3.0/img/texto.jpg" onClick="" width="22" height="22" /></a></td>
			</tr>					
		</c:forEach>
		</tbody></table>
	</form>
