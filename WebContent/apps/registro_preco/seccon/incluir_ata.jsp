...
<input type="hidden" name="numPregao" id="numPregao" value="<%=vnumPregao%>"/>
 		<div id="numero_ata">
    		<fieldset>
                ...
                <input title="Número da ata" alt="Número da ata" type="text" name="num_ata" id="num_ata" size="3" maxlength="3" onblur="poeZero();" /> / <input title="Ano da ata" alt="Ano da ata" type="text" name="ano_ata" id="ano_ata" size="4" maxlength="4" value="<%=vano %>" />
            </fieldset>
	    </div>
      ...
      <div id="botao">
          ...
          <input type="button" name="cancelar" value="Cancelar" onclick="carregaPag('/gecoi.3.0/apps/registro_preco/seccon/lista_registro.jsp?idLicitacao=<%=vidLicitacao%>&nPregao=<%=vnumPregao%>&nProcesso=<%=vnumProcesso%>&edital=<%=vedital %>','divbusca');" />
