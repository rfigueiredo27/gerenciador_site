...
function listar()
{
	...
	else
	{
		...
		$.post("/gecoi.3.0/apps/registro_preco/secomp/lista_licitacao.jsp", { vtexto: document.fbusca.texto.value, vano: document.fbusca.ano.value }, function(resposta) {$("#divbusca").html(resposta);zera_contador();});
	}
}
...
function listarAta()
{
	if (document.fbuscaAta.ano_ata.value == "0")
	{
		alert("Escolha um ano para prosseguir.");
	}
	else
	{
		...
		$.post("/gecoi.3.0/apps/registro_preco/secomp/lista_ata.jsp", { vtexto: document.fbuscaAta.texto_ata.value, vano: document.fbuscaAta.ano_ata.value }, function(resposta) {$("#divbuscaAta").html(resposta);zera_contador();});
	}
}
