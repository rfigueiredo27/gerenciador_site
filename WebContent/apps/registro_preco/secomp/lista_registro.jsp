...
%>
                ...
                <div id="anexo">   			
        			<a href="#" onclick="carregaPag('/gecoi.3.0/apps/registro_preco/secomp/incluir_ata.jsp?nProcesso=${numProcesso}&idLicitacao=${idLicitacao}&nPregao=${numPregao}&edital=${edital}','divbusca');">(+) Incluir Ata</a>
                </div>
        </div>
	</form>
