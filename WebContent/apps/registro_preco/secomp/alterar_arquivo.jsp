...
{
	carregaPag("/gecoi.3.0/apps/registro_preco/secomp/lista_registro.jsp?idLicitacao=" + document.farquivo.idLicitacao.value + "&nPregao=" + document.farquivo.nPregao.value + "&nProcesso=" + document.farquivo.nProcesso.value + "&edital=" + document.farquivo.edital.value, "divbusca");
}
</script>
...
function atualizaTela()
{
	carregaPag("/gecoi.3.0/apps/registro_preco/secomp/lista_registro.jsp?idLicitacao=" + document.farquivo.idLicitacao.value + "&nPregao=" + document.farquivo.nPregao.value + "&nProcesso=" + document.farquivo.nProcesso.value, "divbusca");
}
</script>
...
<input type="hidden" name="idarquivo" id="idarquivo" value="<%=vidArquivo%>"/>
		...
		<div id="progressBar" style="display: none;">
         ...
         <div id="botao">
			...
			<input type="button" name="cancelar" value="Cancelar" onclick="carregaPag('/gecoi.3.0/apps/registro_preco/secomp/lista_registro.jsp?idLicitacao=<%=vidLicitacao%>&nPregao=<%=vnPregao%>&nProcesso=<%=vnProcesso%>','divbusca');" />
           	<input type="button" name="save" value="Grava alterações" onclick="critica_altera_substituicao_arquivo(document.farquivo);" />
        </div>
