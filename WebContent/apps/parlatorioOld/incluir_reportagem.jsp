...
/*
 ...
 selector: "textarea",
   ...
   save_onsavecallback: function () {$.post("/gecoi.3.0/apps/global/salvar_tinymce.jsp", {texto : document.fincReportagem.mytextarea.value}, function(resposta){$("#rodape").html(resposta);alert("1");}); },
   image_advtab: true,
...
function atualizaTela()
{
	...
	//carregaPag("/gecoi.3.0/apps/parlatorio/incluir_reportagem.jsp", "tabs-31");
