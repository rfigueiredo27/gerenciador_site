...
%>
<h1>Altera&ccedil;&atilde;o da refer&ecirc;ncia da ata de registro de pre&ccedil;os</h1>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
        	Descrição <br>
        	<a href="/gecoi.3.0/apps/global/visualizar_arquivo.jsp?idConteudo=<%=vidConteudo %>&idArquivo=<%=vidArquivo %>" target="_blank"> <%=vdescricaoCompleta %> </a>
        </td>
      </tr>
      <tr>
        <td>
