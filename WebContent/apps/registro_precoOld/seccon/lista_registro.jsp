...
function excluirAnexo(vidConteudo, plicitacao, pnProcesso, pnPregao, pata)
{
	if (confirm("Deseja realmente excluir a ata " + pata + " ?") == true)
		$.post("/gecoi.3.0/apps/registro_preco/seccon/processa_exclusao.jsp", {idConteudo : vidConteudo}, 
				function(){carregaPag("/gecoi.3.0/apps/registro_preco/seccon/lista_registro.jsp?idLicitacao=" + plicitacao + "&nPregao=" + pnPregao + "&nProcesso=" + pnProcesso,"divbusca");});
}
</script>
<%
		...
		<form name="fanexo" action="/gecoi.3.0/apps/registro_preco/seccon/lista_registro.jsp?idLicitacao=${idLicitacao }&nProcesso=${numProcesso }&nPregao=${numPregao }" method="post" enctype="multipart/form-data">
			...
			<div id="numero">
				<div id="numero_processo">
        			<p>N&uacute;mero do processo: <br /><strong><%=vnumPregao %></strong></p>
				</div>
    			<div id="numero_pregao">
     				<p>N&uacute;mero do preg&atilde;o: <br /><strong><%=vnumProcesso %></strong></p>
				</div>
            </div>
            <div id="anexo_tabela">
			 <table id="tb_gecoi">
				<tr>
					...
					<th scope="col" width="10%">PUBLICA&Ccedil;&Atilde;O</th>
					<th scope="col" width="10%">VIG&Ecirc;NCIA</th>
...
%>
      			...
      			<tr  bgcolor=<%=vcor%> >
        			<td align="left">${anexo.numAta } - ${anexo.descricao }</td>
        			...
        			<td width="2%"><a href="/gecoi.3.0/apps/global/visualizar_arquivo.jsp?idConteudo=${anexo.idConteudo }&idArquivo=${anexo.idArquivo }" target="_blank" title="Visualização do arquivo"><img id="arquivo${anexo.idConteudo }" name="arquivo${anexo.idConteudo }" src="/gecoi.3.0/img/consulta.png" onclick="" width="22" height="22" target="_blank" /></a></td>
           			...
           			<td width="2%"><a href="#" onclick="carregaPag('/gecoi.3.0/apps/registro_preco/seccon/alterar_dados_ata.jsp?idLicitacao=${idLicitacao }&id=${anexo.idArquivo }&descricao=${anexo.descricao }&idConteudo=${anexo.idConteudo }&nProcesso=${numProcesso}&nPregao=${numPregao}&dataPublicacao=${anexo.dataPublicacao}&dataVigenciaInicial=${anexo.dataVigenciaInicial}&dataVigenciaFinal=${anexo.dataVigenciaFinal}&idArea=${anexo.idArea}&numAta=${anexo.numAta }','divbusca');" title="Alterar dados da Ata"><img src="/gecoi.3.0/img/editar_cinza.png" onclick="" width="22" height="22" /></a></td>
           			<td width="2%"><a href="#" onclick="excluirAnexo(${anexo.idConteudo }, ${idLicitacao}, '${numPregao}', '${numProcesso}', '${anexo.numAta }');" title="Exclusão da Ata"><img src="/gecoi.3.0/img/excluir_cinza.png" width="22" height="22" /></a></td>
        			</td>
      			</tr>
			</c:forEach>
     			</table> 
                <div id="anexo">   			
        			<a href="#" onclick="carregaPag('/gecoi.3.0/apps/registro_preco/seccon/incluir_ata.jsp?nProcesso=${numProcesso}&idLicitacao=${idLicitacao}&nPregao=${numPregao}','divbusca');">(+) Incluir Ata</a>
                </div>
        </div>
	</form>
