...
function atualizaTela(pnumAta)
{
	...
	carregaPag("/gecoi.3.0/apps/registro_preco/secomp/lista_registro.jsp?idLicitacao=" + document.fincAnexo.idArquivo.value + "&nProcesso=" + document.fincAnexo.numProcesso.value + "&nPregao=" + document.fincAnexo.numPregao.value, "divbusca");
}
