 ...
 function listar()
{
	...
	$.post("/gecoi.3.0/apps/registro_preco/secomp/lista_licitacao.jsp", { vtexto: document.fbusca.texto.value, vano: document.fbusca.ano.value }, function(resposta) {$("#divbusca").html(resposta);});
}
