function critica_inclusao(f)
{
	...
	{
		msg = msg + "- O campo DESCRICAO DO EDITAL \u00e9 de preenchimento obrigat\u00f3rio.\n";
	}
	
	if (f.descricao2.value.replace(/^\s*|\s*$/g,"")=="")
	{
		msg = msg + "- O campo DESCRICAO DO DOCUMENTO PARA ELIMINACAO \u00e9 de preenchimento obrigat\u00f3rio.\n";
	}
