...
function atualizaTela(pnumAta)
{
	...
	carregaPag("/gecoi.3.0/apps/registro_preco/seccon/alterar_anexo.jsp?idLicitacao=" + document.fincAnexo.idArquivo.value + "&nProcesso=" + document.fincAnexo.numProcesso.value + "&nPregao=" + document.fincAnexo.numPregao.value, "divbusca");
}
...
<input type="hidden" name="app" id="app" value="/gecoi.3.0/apps/registro_preco/seccon/alterar_anexo.jsp?idLicitacao=<%=vidLicitacao%>&nPregao=<%=vnumPregao%>&nProcesso=<%=vnumProcesso %>"/>
