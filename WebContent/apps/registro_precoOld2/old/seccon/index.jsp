 ...
 function listar(f)
{
	...
	$.post("/gecoi.3.0/apps/registro_preco/seccon/lista_registro.jsp", { vtexto: document.fbusca.texto.value, vano: document.fbusca.ano.value }, function(resposta) {$("#divbusca").html(resposta);});
}
