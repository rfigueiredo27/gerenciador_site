	...
	<c:when test="${!empty items}">
		...
		<c:forEach var="registro" items="${items}" >
			<tr>
				...
				<td><a href="#" onclick="carregaPag('/gecoi.3.0/apps/registro_preco/seccon/alterar_anexo.jsp?idLicitacao=${registro.idArquivo }&nPregao=${registro.numPregao }&nProcesso=${registro.numProcesso }','divbusca');"  title="Manutenção das Atas"><img id="aditivo${registro.idConteudo }" name="aditivo${registro.idConteudo }" src="/gecoi.3.0/img/texto.jpg" onclick="" width="30" height="30" /></a></td>
			</tr>					
		</c:forEach>
		</table>
	</form>
