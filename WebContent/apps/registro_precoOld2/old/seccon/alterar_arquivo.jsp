...
{
	carregaPag("/gecoi.3.0/apps/registro_preco/seccon/alterar_anexo.jsp?idLicitacao=" + document.farquivo.idLicitacao.value + "&nPregao=" + document.farquivo.nPregao.value + "&nProcesso=" + document.farquivo.nProcesso.value, "divbusca");
}
</script>
...
String vpagina = "/gecoi.3.0/apps/registro_preco/seccon/alterar_anexo.jsp?idLicitacao=" + vidLicitacao + "&nPregao=" + vnPregao + "&nProcesso=" + vnProcesso;
%>
