...
function criticaAnexo(pLicitacao, pnPregao, pnProcesso)
{
	...
	{
		$.post("/gecoi.3.0/apps/registro_preco/secomp/processa_alteracao_dados_ata.jsp", {idConteudo: document.fdescAnexo.idconteudo.value, 
				...
				function(){
					//$.post("/gecoi.3.0/apps/registro_preco/secomp/alterar_anexo.jsp?id=" + document.fdescAnexo.idconteudo.value, function(){document.fdescAnexo.submit()});
					/*$.post("/gecoi.3.0/apps/registro_preco/secomp/alterar_anexo.jsp?idLicitacao=" + document.fdescAnexo.idlicitacao.value +
					...
					carregaPag("/gecoi.3.0/apps/registro_preco/secomp/alterar_anexo.jsp?idLicitacao=" + pLicitacao + "&nPregao=" + pnPregao + "&nProcesso=" + pnProcesso,"divbusca");
				});
	}
}
</script>
...
%>
<h1>Altera&ccedil;&atilde;o dos dados da ata de registro de pre&ccedil;osxxx</h1>
<form name="fdescAnexo" action="/gecoi.3.0/apps/registro_preco/secomp/alterar_anexo.jsp?idLicitacao=<%=vidLicitacao %>&nPregao=<%=vnPregao %>&nProcesso=<%=vnProcesso %>" method="post"> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="40" align="right" valign="middle">
           <input type="button" name="cancelar" value="Cancelar" onclick="carregaPag('/gecoi.3.0/apps/registro_preco/secomp/alterar_anexo.jsp?idLicitacao=<%=vidLicitacao%>&nPregao=<%=vnPregao%>&nProcesso=<%=vnProcesso%>','divbusca');" />
