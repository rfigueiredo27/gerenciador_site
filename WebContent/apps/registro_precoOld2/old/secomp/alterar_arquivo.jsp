...
{
	carregaPag("/gecoi.3.0/apps/registro_preco/secomp/alterar_anexo.jsp?idLicitacao=" + document.farquivo.idLicitacao.value + "&nPregao=" + document.farquivo.nPregao.value + "&nProcesso=" + document.farquivo.nProcesso.value, "divbusca");
}
</script>
<%
...
String vpagina = "/gecoi.3.0/apps/registro_preco/secomp/alterar_anexo.jsp?idLicitacao=" + vidLicitacao + "&nPregao=" + vnPregao + "&nProcesso=" + vnProcesso;
%>

<h1>Troca de arquivo de ata de registro de pre&ccedil;os</h1>
<h2>N&uacute;mero do processo: <%= vnProcesso%><br>
N&uacute;mero do preg&atilde;o: <%= vnPregao%><br>
Descri&ccedil;&atilde;o da ata: <%= vdescricao%></h2> <br><br>
