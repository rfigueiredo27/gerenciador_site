...
<div id='tabs'>
   ...
   <div id='tabs-1'>
   		<form name="fdestaque" action="/gecoi.3.0/GravaNovoDestaque" method="post"  target="processa_background" enctype="multipart/form-data">
            ...
            <input name="dataIni" id="dataIni" type="text" maxlength="1000" /><br>
        	Data fim da publica&ccedil;&atilde;o<br>
            <input name="dataFim" id="dataFim" type="text" maxlength="1000" /><br>
        	Ordem<br>        	
            <input name="publicado" id="publicado" type="text" maxlength="1000" onkeypress="soNumero(event);" maxlength="1" value="1" /><br>
