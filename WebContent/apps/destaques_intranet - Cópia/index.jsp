   ...
   <div id='tabs-1'>
   		<form name="fdestaque" action="/gecoi.3.0/GravaNovoDestaque" method="post"  target="processa_background" enctype="multipart/form-data">
            ...
            <fieldset>
	            ...
	            Digite: <input name="link" id="link" type="text" maxlength="1000" /> OU
	            Escolha um anexo: <input type="text" name="descricaoAnexo" id="descricaoAnexo" /><input type="file" name="anexo" id="anexo" />
            ...
            <fieldset>
            	<legend>Banner a ser incluso</legend>
