...
$base_url="http://intranet.tre-rj.gov.br"; //url base of site if you want only relative url leave empty
$upload_dir = '/gecoi.3.0/gecoi_arquivos/'; // path from base_url to upload base dir
